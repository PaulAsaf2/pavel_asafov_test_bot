...
const certificateProd = InlineKeyboard.webApp('certificate | magnetto.monitour.ru', 'https://magnetto.monitour.ru/certificate_webapp/?lead=1234567');
...
const buttons = [certificateProd, certificateDev, testWebApp, wallstringDev, cropImageProd, wallstringProd, magnettopro, magnettoproDev];
